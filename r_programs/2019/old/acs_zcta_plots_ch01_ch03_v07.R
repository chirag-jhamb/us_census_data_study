...
# load the data
acs_zcta_2012_2016 <- read.csv(paste0(data_dir,"20190303_acs_zcta_2013_2017.csv"),stringsAsFactors = F)
...
plot_zcta_level_quantile_values <- function(df,colname,area_type){
  ...
  p <- ggplot(df.int) +
    ...
    geom_sf(data = metro_dc, fill=NA, colour = "#de2d26", size=0.5)+
    geom_sf(data = national_highway_interstate.int, fill=NA, colour = "#fc9272", size=0.5)+
    geom_sf(data = cborders1960c, fill=NA, colour = "#737373", size=0.5)+
    coord_sf() +
    theme_map() +
