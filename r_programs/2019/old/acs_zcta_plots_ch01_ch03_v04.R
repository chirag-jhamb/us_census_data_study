...
plot_zcta_level_quantile_values <- function(df,colname,area_type){
    ...
    if (colname_str=='new_constructions'){
      save_plot <- paste0(out_dir,"c1.m1.",area_type,"_",dateo,"_acs_zcta_quantiles_of_",colname_str,".jpg")
    } else if (colname_str=='new_existing_constructions_ratio'){
      save_plot <- paste0(out_dir,"c1.m2.",area_type,"_",dateo,"_acs_zcta_quantiles_of_",colname_str,".jpg")
    } else if (colname_str=='share_single_family_new_constructions'){
      save_plot <- paste0(out_dir,"c2.m1.",area_type,"_",dateo,"_acs_zcta_quantiles_of_",colname_str,".jpg")
    } else if (colname_str=='Median.value..dollars'){
      save_plot <- paste0(out_dir,"c3.m1.",area_type,"_",dateo,"_acs_zcta_quantiles_of_",colname_str,".jpg")
    }  else {
      save_plot <- paste0(out_dir,"c3.m1.",area_type,"_",dateo,"_acs_zcta_quantiles_of_",colname_str,".jpg")
    }
