...
plot_zcta_level_quantile_values <- function(df,colname,area_type){
  ...
  p <- ggplot(df.int) +
    ...
    geom_sf(data = cborders1960c, fill=NA, colour = "#545353", size=1.6)+
    coord_sf() +
    theme_map() +
 ...
 # print(tester)
  ...
  if (colname_str=='new_constructions' & area_type=="00000"){
    save_plot <- paste0(out_dir_c,"p1.m1.",area_type,"_",dateo,".jpg")
    write.csv(df.int_sub,paste0(out_dir_d,"p1.m1.",area_type,"_",dateo,".csv"),
              row.names = F)
  } #else if (colname_str=='new_existing_constructions_ratio'){
  #   save_plot <- paste0(out_dir_c,"p1.m2.",area_type,"_",dateo,".jpg")
  #   write.csv(df.int_sub,paste0(out_dir_d,"p1.m2.",area_type,"_",dateo,".csv"),
  #             row.names = F)
  # } else if (colname_str=='share_single_family_new_constructions'){
  #   save_plot <- paste0(out_dir_c,"p2.m1.",area_type,"_",dateo,".jpg")
  #   write.csv(df.int_sub,paste0(out_dir_d,"p2.m1.",area_type,"_",dateo,".csv"),
  #             row.names = F)
  # }
...
plot_zcta_level_quantile_values <- function(df,colname,statefips,countyfips){
  ...
  if (colname_str=='new_constructions'){
    save_plot <- paste0(out_dir_c,"c1.m1.",sfips,cfips,"_",dateo,".jpg")
    write.csv(df.int_sub,paste0(out_dir_d,"c1.m1.",sfips,cfips,"_",dateo,".csv"),
              row.names = F)
  } else if (colname_str=='new_existing_constructions_ratio'){
    save_plot <- paste0(out_dir_c,"c1.m2.",sfips,cfips,"_",dateo,".jpg")
    write.csv(df.int_sub,paste0(out_dir_d,"c1.m2.",sfips,cfips,"_",dateo,".csv"),
              row.names = F)
  } else if (colname_str=='share_single_family_new_constructions'){
    save_plot <- paste0(out_dir_c,"c2.m1.",sfips,cfips,"_",dateo,".jpg")
    write.csv(df.int_sub,paste0(out_dir_d,"c2.m1.",sfips,cfips,"_",dateo,".csv"),
              row.names = F)
  } 
