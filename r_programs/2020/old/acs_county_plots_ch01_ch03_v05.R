...
# load the data
acs_cnt_2007_2011 <- read.csv(paste0(data_dir,"20190227_cnty_acs_2007_2011_absolute_values.csv"),stringsAsFactors = F)
acs_cnt_2008_2012 <- read.csv(paste0(data_dir,"20190227_cnty_acs_2008_2012_absolute_values.csv"),stringsAsFactors = F)
acs_cnt_2009_2013 <- read.csv(paste0(data_dir,"20190227_cnty_acs_2009_2013_absolute_values.csv"),stringsAsFactors = F)
acs_cnt_2010_2014 <- read.csv(paste0(data_dir,"20190227_cnty_acs_2010_2014_absolute_values.csv"),stringsAsFactors = F)
acs_cnt_2011_2015 <- read.csv(paste0(data_dir,"20190227_cnty_acs_2011_2015_absolute_values.csv"),stringsAsFactors = F)
acs_cnt_2012_2016 <- read.csv(paste0(data_dir,"20190227_cnty_acs_2012_2016_absolute_values.csv"),stringsAsFactors = F)
...
write.csv(df,paste0(out_dir_ch01,"p1.g1_",dateo,"_acs_cnt_1950_2016_housing_units_area_wise.csv"),row.names = F)
...
###################### P1.G3. Plot Housing Units Percent change from 200 to 2016 vs Median Housing Value 2000 ###################################################
...
# save the graph
ggsave(paste0(out_dir_ch01,"p1.g3_",dateo,"_acs_cnt_comp_2000_2016_scatter_house_median_value_percent_change_housing_units.jpg"),
       plot = p1, dpi = 300, width = 16, height = 11, units = c("in"))

write.csv(acs_cnt_2000_2016_comp_pct_2000,
          paste0(out_dir_ch01,"p1.g3_",dateo,"_acs_cnt_comp_2000_2016_scatter_house_median_value_percent_change_housing_units.csv"),row.names = F)
...
write.csv(df,paste0(out_dir_ch02,"p2.g1_",dateo,"_acs_cnt_1950_2016_housing_units_by_unit_type_and_count.csv"),row.names = F)
...
write.csv(df,paste0(out_dir_ch03,"p3.g2_",dateo,"_acs_cnt_2016_","median_housing_value_by_median_hh_income",".csv"),row.names = F)
...
# save the plot
ggsave(paste0(out_dir_ch03,"p3.b1_",dateo,"_acs_cnt_1950_2016_renters_burden_area_race_wise.jpg"),
       plot = p1, dpi = 300, width = 16, height = 11, units = c("in"))

df$group <- NULL

write.csv(df,paste0(out_dir_ch03,"p3.b1_",dateo,"_acs_cnt_1950_2016_renters_burden_area_race_wise.csv"),row.names = F)
...
ggsave(paste0(out_dir_ch03,"p3.g3_",dateo,"_acs_cnt_2016_","median_gross_rent_as_a_percentage_of_household_income",".jpg"),
       plot = p1, dpi = 300, width = 16, height = 11, units = c("in"))

write.csv(df,paste0(out_dir_ch03,"p3.g3_",dateo,"_acs_cnt_2016_","median_gross_rent_as_a_percentage_of_household_income",".csv"),row.names = F)
