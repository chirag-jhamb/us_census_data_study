...
# April 10, 2019
#
# acs_county_plots_ch01_ch03_v12.R
#
##############################################################################
##############################################################################
...
acs_cnt_1950_2017 %>%
  filter(year=='2017' & countyfips=="001") 
...
ggsave(paste0(out_dir_ch01,"p1.g1_",dateo,"_acs_cnt_1950_2017_housing_units_area_wise.jpg"),
       plot = p1, dpi = 300, width = 16, height = 16, units = c("in"))
...
#acs_cnt_2000_2017_comp <- acs_cnt_2000_2017_comp %>% filter(year=='2017')
...
p1 <- ggplot(data = acs_cnt_2000_2017_comp , aes(x = median_housing_value_2000, y = housing_units_pct_change_from_2000)) +
  ...
  annotate(geom="text", x=326000, y=31, label="all counties", color="#bdbdbd", size=10)+
  annotate(geom="text", x=40000, y=52, label="without loudoun", color="#525252", size=10)+
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
g1 <- ggplot(data = df, aes(x = county_name_state_code, y = single_family_prop, fill=group)) +
  ...
  theme(panel.grid.major = element_blank(),
        ...
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
        axis.text = element_text(size = 30, colour = axis_labs_col),
        legend.position="none",
...
p1 <- ggplot(df_all_years, aes(x=year)) +
  ...
  theme(panel.grid.major = element_blank(),
        ...
        axis.ticks.y = element_blank(),
        axis.text = element_text(size = 30, colour = axis_labs_col),
        axis.title.x = element_text(size = 30, colour = axis_labs_col),
        axis.title.y = element_text(size = 30, colour = axis_labs_col),
        plot.title = element_text(size=25),
        legend.title = element_blank(),
        legend.position="none",
        legend.justification = c(1,1),
...
write.csv(df_table,paste0(out_dir_appendix,"t1.",dateo,"_",col_name,".csv"),row.names = F)
  ...
  colnames(df_table) <- c("Name","Housing Units\n2017","Housing Units\n2010", "Housing Units\n2000")
