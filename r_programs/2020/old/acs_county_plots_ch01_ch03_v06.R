...
p1 <- ggplot(data = acs_cnt_2000_2017_comp_pct_2000 , aes(x = median_housing_value, y = housing_units_pct_change_from_2000)) +
  ...
  labs(x = "", y="percentage change in number of housing units, 2000 to 2017")+
...
p1 <- ggplot(df, aes(x=year)) +
  ...
  scale_shape_manual(values = c(16, 21)) +
  annotate(geom="text", x=1990, y=320000, label="Median house value", color=col_median_val, size=12)+
  annotate(geom="text", x=1990, y=105000, label="Median household income", color=col_median_hh, size=12)+
  #labs(x="", y="") +
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
...
# 
# 
p1 <- p+annotate(geom="text", x=0.78, y=7.5, label="Housing growth", color=col, size=siz)+
  annotate(geom="text", x=1.225, y=7.5, label="Population growth", color=col, size=siz)
