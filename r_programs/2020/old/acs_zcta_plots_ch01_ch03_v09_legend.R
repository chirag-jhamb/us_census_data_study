...
out_dir_county_maps <- paste0(groupDir,"/center_for_washington_area_studies/state_of_the_capitol_region/r_output/2019/county_page/county_maps/county_maps_legends/")
...
#data %>% dplyr::select(matches('^total_single_family*')) %>% head(2)
