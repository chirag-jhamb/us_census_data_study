...
p1 <- grid.arrange(gg1,gg.mid,gg2,
		   ncol=3,
		   widths=c(2.4/9,2.4/9,4.2/9))

## graph with empty first panel
t <- textGrob("")
p01 <- grid.arrange(t,gg.mid,gg2,ncol=3,widths=c(2.4/9,2.4/9,4.2/9))
...
ggsave(paste0(out_dir_pres,"p2_g2_noshare_",dateo,".jpg"),
       plot = p01, dpi = 300, width = 22, height = 11, units = c("in"))
