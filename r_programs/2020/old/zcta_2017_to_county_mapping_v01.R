...
zctas <- st_read(paste0(groupDir,"/maps/united_states/census2010/zcta/2017_census_zcta_shapefile"),layer="cb_2017_us_zcta510_500k",stringsAsFactors = F)
...
int.counties_zctas_greater_0.5 <- int.counties_zctas %>% filter(percent_intersected_area>0.5)
