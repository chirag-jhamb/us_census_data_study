...
#     plot_c1_g1(acs_cnt_2012_2016_subset_built_year_melt,sfips,cfips)
#   } else if (sfips=="51"){
#     #cfips <- c("013","043","047","059","061","107","153","157","177","179","187","510","600","610","630","683","685")
#     cfips <- c("013")
#     plot_c1_g1(acs_cnt_2012_2016_subset_built_year_melt,sfips,cfips)
#   }else if (sfips=="24"){
