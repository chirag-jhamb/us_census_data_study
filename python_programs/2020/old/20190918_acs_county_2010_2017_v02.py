...
def get_summary_year_data(start_year, end_year):
    ...
    def get_summary_data(state):
        ...
        Household_under18_df = get_data('HOUSEHOLDS BY PRESENCE OF PEOPLE UNDER 18 YEARS BY HOUSEHOLD TYPE', 'B11005', state)
        # Race_df = get_data('RACE', 'B02001', state)
        ...
        data_frames = [Household_under18_df]
        # if int(end_year) > 2010:
        ...
        #                Race_Hispanic_Latino_df_subset, Gross_Rent_df_subset,
        #                Gross_Rent_percent_df_subset, Tenure_year_df_subset]
        # else:
        #     data_frames = [Population_df, Age_df_subset, Race_df_subset, Household_df_subset, Education_df_subset,
        #                    Income_df_subset, Median_Income_df_subset, NoOfHousing_df_subset, Tenure_df_subset,
...
#
    filename = datetime.datetime.today().strftime(
        '%Y%m%d') + '_cnty_acs_' + estimate_start_year + '_' + estimate_end_year + '_absolute_values2.csv'
    print(filename)
    print(type(filename))
...
#end_year = ['2009','2010']
#
end_year = ['2009', '2010' , '2011', '2012', '2013', '2014', '2015', '2016','2017']
#
#end_year = ['2016']
fails = []
