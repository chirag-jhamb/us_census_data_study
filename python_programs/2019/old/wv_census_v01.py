...
Population_df = get_data('TOTAL POPULATION','B01003','WV')
Age_df = get_data('SEX BY AGE','B01001','WV')
Race_df = get_data('RACE','B02001','WV')
Household_df = get_data('HOUSEHOLD TYPE (INCLUDING LIVING ALONE)','B11001','WV')
Education_df = get_data('SEX BY EDUCATIONAL ATTAINMENT FOR THE POPULATION 25 YEARS AND OVER','B15002','WV')
Income_df = get_data('HOUSEHOLD INCOME IN THE PAST 12 MONTHS (IN 2009 INFLATION-ADJUSTED DOLLARS)','B19001','WV')
NoOfHousing_df = get_data('HOUSING UNITS','B25001','WV')
Tenure_df = get_data('TENURE','B25003','WV')
TypeOfHousing_df = get_data('UNITS IN STRUCTURE','B25024','WV')
AgeOfHousing_df = get_data('YEAR STRUCTURE BUILT','B25034','WV')
Value_df = get_data('VALUE','B25075','WV')
...
Population_df_county = Population_df_county.query('COUNTY in ["037"]')
Age_df_county = Age_df_county.query('COUNTY in ["037"]')

print(Population_df_county.loc[:,["COUNTY","Total","GEO_NAME"]])
print(Age_df_county)


#                        (p1960$fipscounty %in% c("009","017","021","031","033") & p1960$fipsstate %in% c("24"))|
 #                        (p1960$fipscounty %in% c("510","013","043","047","059","600","610","061","630",
  #                                                    "107","683","685","153","157","177","179","187")
   #                       & p1960$fipsstate %in% c("51"))|
    #                     (p1960$fipscounty %in% c("037")&p1960$fipsstate %in% c("54"))),]
