...
dataDir = r'/groups/brooksgrp/census/american_community_survey/2012_2016_5year_estimates/raw_data/group1/'
...
def get_data(table_title, table_id):
    ...
    path = dataDir + '/e20165' + 'us' + '0' + str(seq_number).zfill(3) + '000.txt'
    print(path)
    ...
    path = '/groups/brooksgrp/census/american_community_survey/2012_2016_5year_estimates/raw_data/geog/g20165us.txt'
    ...
    table_name = table_title.replace(" ", "_") + str("_zcta_2016.csv")
    print(table_name)
    ...
    # check unique values in summary level
    #   print(data['SUMMARY_LEVEL'].value_counts())
    #    print(data['COUNTY'])
...
Median_Income_df = get_data('MEDIAN HOUSEHOLD INCOME IN THE PAST 12 MONTHS (IN 2016 INFLATION-ADJUSTED DOLLARS)',
                            'B19013')
...
data_frames = [Population_df, Age_df, Race_df, Household_df, Education_df, Income_df, Median_Income_df, NoOfHousing_df,
               Tenure_df, MedianValue_df, AgeOfHousing_df, Tenure_by_year_df]
...
state_county_zcta_data = pd.read_csv(os.path.join(path_to_zcta_county_mapping, "20181217_state_county_zcta.csv"),
...
save_file = os.path.join(outDir, "acs_zcta_2012_2016.csv")
print(save_file)
...
# print(df)
#
# data_path = r'/groups/brooksgrp/census/american_community_survey/2012_2016_5year_estimates/raw_data/' \
#                 r'All_Geographies_Not_Tracts_Block_Groups/'
#
# filename = datetime.datetime.today().strftime('%Y%m%d')+'_cnty_acs_'+estimate_start_year+'_'+estimate_end_year+'_absolute_values.csv'
# print(filename)
# print(type(filename))
#
# save_file = os.path.join(data_path, str(filename))
#
# print(save_file)
#
#
