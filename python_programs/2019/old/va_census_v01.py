...
Population_df = get_data('TOTAL POPULATION','B01003','VA')
Age_df = get_data('SEX BY AGE','B01001','VA')
Race_df = get_data('RACE','B02001','VA')
Household_df = get_data('HOUSEHOLD TYPE (INCLUDING LIVING ALONE)','B11001','VA')
Education_df = get_data('SEX BY EDUCATIONAL ATTAINMENT FOR THE POPULATION 25 YEARS AND OVER','B15002','VA')
Income_df = get_data('HOUSEHOLD INCOME IN THE PAST 12 MONTHS (IN 2009 INFLATION-ADJUSTED DOLLARS)','B19001','VA')
NoOfHousing_df = get_data('HOUSING UNITS','B25001','VA')
Tenure_df = get_data('TENURE','B25003','VA')
TypeOfHousing_df = get_data('UNITS IN STRUCTURE','B25024','VA')
AgeOfHousing_df = get_data('YEAR STRUCTURE BUILT','B25034','VA')
Value_df = get_data('VALUE','B25075','VA')
...
Population_df_county = Population_df_county.query('COUNTY in ["510","013","043","047","059","600","610","061",'
                                                  '"630", "107","683","685","153","157","177","179","187"]')
Age_df_county = Age_df_county.query('COUNTY in ["510","013","043","047","059","600","610","061","630",'
...
print(Population_df_county.columns)
print(Age_df_county.columns)
print(Race_df_county.columns)
print(Household_df_county.columns)
print(Education_df_county.columns)
print(Income_df_county.columns)
print(NoOfHousing_df_county.columns)
print(Tenure_df_county.columns)
print(TypeOfHousing_df_county.columns)
print(AgeOfHousing_df_county.columns)
print(Value_df_county.columns)
