...
def rununtilcomplete():
    while True:
        try:
            download_acs(
                "https://www2.census.gov/programs-surveys/acs/summary_file/2017/documentation/user_tools/ACS_5yr_Seq_Table_Number_Lookup.xls",
                "/groups/brooksgrp/census/american_community_survey/2013_2017_5year_estimates/documentation/",
                "https://www2.census.gov/programs-surveys/acs/summary_file/2017/data/5_year_by_state",
                "/groups/brooksgrp/census/american_community_survey/2013_2017_5year_estimates/raw_data/All_Geographies_Not_Tracts_Block_Groups/")
...
os.system('mv /groups/brooksgrp/census/american_community_survey/2013_2017_5year_estimates/raw_data/All_Geographies_Not_Tracts_Block_Groups/*_Tracts_Block_Groups_Only.zip /groups/brooksgrp/census/american_community_survey/2013_2017_5year_estimates/raw_data/Tracts_Block_Groups_Only/')
